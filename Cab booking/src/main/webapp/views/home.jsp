	...
	<body>
		...
		<div class="container mt-5">
			<div class="row center">
				<!-- Card 1 -->
				<div class="col-8 mb-5"> <!-- Changed from col-md-6 to col-12 -->
					<div class="card">
						<div class="card-body text-center">
							<h5 class="card-title">If you already have an account click here to login</h5>
				...
				<div class="col-8 mb-5"> <!-- Changed from col-md-6 to col-12 -->
					<div class="card">
						<div class="card-body text-center">
							<h5 class="card-title">If you are a new user, click here to sign up</h5>
